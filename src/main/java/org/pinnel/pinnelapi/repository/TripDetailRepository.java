...
public interface TripDetailRepository extends JpaRepository<TripDetailEntity, Long> {
    ...
    /** Returns all details for a given (tripId, visitDate) ordered by cityOrder ascending. */
    List<TripDetailEntity> findByTripIdAndVisitDateOrderByCityOrder(Long tripId, LocalDate visitDate);
}
